...
//  the Advent calendar; the second puzzle is unlocked when you complete the first.Each puzzle grants one star.Good luck!
//
...
// sweep looks furtherand further away from the submarine.
//
